        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 space-y-6 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-inter animate-fade-in">
              <span className="text-cloud-dark-blue dark:text-white">Cloud Infrastructure</span>
              <br />
              <span className="text-cloud-bright-blue">Architect & DevOps</span>
              <br />
              <span className="text-cloud-azure">Specialist</span>
            </h1>
            
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 animate-fade-in [animation-delay:200ms]">
              Transforming complex infrastructure challenges into elegant, scalable solutions. 
              Bridging the gap between innovation and enterprise-grade reliability.
            </p>
            ...
            <div className="pt-4 flex flex-wrap gap-4 justify-center md:justify-start animate-fade-in [animation-delay:600ms]">
              <Button className="cloud-button">View Projects</Button>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="relative">
                  ...
                  <svg className="absolute inset-0 w-full h-full -z-10" xmlns="http://www.w3.org/2000/svg">
                    <line x1="32" y1="32" x2="128" y2="128" stroke="rgba(0, 98, 163, 0.5)" strokeWidth="2" strokeDasharray="5,5" />
                    <line x1="224" y1="148" x2="160" y2="128" stroke="rgba(0, 98, 163, 0.5)" strokeWidth="2" strokeDasharray="5,5" />
                    <line x1="128" y1="224" x2="128" y2="160" stroke="rgba(0, 98, 163, 0.5)" strokeWidth="2" strokeDasharray="5,5" />
                  </svg>
                </div>
              </div>
            </div>
