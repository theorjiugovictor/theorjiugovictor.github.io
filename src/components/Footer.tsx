			...
			<div className="container mx-auto px-4">
				<div className="flex flex-col md:flex-row justify-between items-center mb-8">
					...
					<div className="flex space-x-8">
						<a
							href="#home"
							className="hover:text-cloud-bright-blue transition-colors"
						>
							Home
						</a>
						<a
				...
				<div className="border-t border-gray-700 pt-8 mt-8">
					<div className="flex flex-col md:flex-row justify-between items-center">
						<p className="text-gray-400 text-sm mb-4 md:mb-0">
							&copy; {currentYear} Prince Victor Orjiugo. All rights reserved.
						</p>

						<div className="flex items-center text-sm text-gray-400">
							<p className="flex items-center">
								Built with <Heart className="h-4 w-4 text-red-500 mx-1" /> to
								make the internet a bit better than I found it.
							</p>
						</div>
					</div>
				</div>
